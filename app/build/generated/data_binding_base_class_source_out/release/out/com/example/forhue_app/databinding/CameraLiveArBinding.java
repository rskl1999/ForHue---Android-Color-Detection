...
public final class CameraLiveArBinding implements ViewBinding {
  @NonNull
  ...
  private CameraLiveArBinding(@NonNull ConstraintLayout rootView,
      @NonNull ImageButton captureButton, @NonNull TextView colorID,
      @NonNull ImageButton fliprotate, @NonNull ConstraintLayout frameLayout,
      @NonNull TextView heightdim, @NonNull ImageButton homeButton,
      @NonNull ImageButton imageButton, @NonNull ImageButton imageButton3,
      @NonNull ConstraintLayout imageView7, @NonNull ImageButton langicon,
      @NonNull JavaCameraView opencvSurfaceView, @NonNull ImageButton pauseButt,
      @NonNull ImageButton resoButton, @NonNull ImageButton resumeButt, @NonNull ListView setLang,
      @NonNull ListView setReso, @NonNull TextView textView16, @NonNull TextView textView19,
      @NonNull TextView textView23, @NonNull TextView textView3, @NonNull ConstraintLayout topView,
      @NonNull TextView widthdim) {
  ...
  @NonNull
  public static CameraLiveArBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static CameraLiveArBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.camera_live_ar, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static CameraLiveArBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new CameraLiveArBinding((ConstraintLayout) rootView, captureButton, colorID,
          fliprotate, frameLayout, heightdim, homeButton, imageButton, imageButton3, imageView7,
          langicon, opencvSurfaceView, pauseButt, resoButton, resumeButt, setLang, setReso,
          textView16, textView19, textView23, textView3, topView, widthdim);
    }
