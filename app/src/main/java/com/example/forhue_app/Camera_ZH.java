...
public class Camera_ZH extends AppCompatActivity implements CameraBridgeViewBase.CvCameraViewListener2{
    ...
    if (ContextCompat.checkSelfPermission(Camera_ZH.this, Manifest.permission.CAMERA) == PackageManager.PERMISSION_DENIED){
    ActivityCompat.requestPermissions(Camera_ZH.this, new String[] {Manifest.permission.CAMERA}, MY_PERMISSIONS_REQUEST_CAMERA);
        }
    //if camera permission is not given, it will ask for it on device
    if (ContextCompat.checkSelfPermission(Camera_ZH.this, Manifest.permission.CAMERA) == PackageManager.PERMISSION_DENIED) {
    ActivityCompat.requestPermissions(Camera_ZH.this, new String[]{ Manifest.permission.CAMERA}, MY_PERMISSIONS_REQUEST_CAMERA);
    ...
    //Write External
    if (ContextCompat.checkSelfPermission(Camera_ZH.this, Manifest.permission.WRITE_EXTERNAL_STORAGE) == PackageManager.PERMISSION_DENIED) {
    ActivityCompat.requestPermissions(Camera_ZH.this, new String[]{ Manifest.permission.WRITE_EXTERNAL_STORAGE}, MY_PERMISSIONS_REQUEST_CAMERA);
        }
    // Read External
    if (ContextCompat.checkSelfPermission(Camera_ZH.this, Manifest.permission.READ_EXTERNAL_STORAGE) == PackageManager.PERMISSION_DENIED) {
    ActivityCompat.requestPermissions(Camera_ZH.this, new String[]{ Manifest.permission.READ_EXTERNAL_STORAGE}, MY_PERMISSIONS_REQUEST_CAMERA);
        }
    else {
        ...
        Toast.makeText(Camera_ZH.this, "Camera changed view", Toast.LENGTH_SHORT).show();
        swapCamera();
        ...
        home_button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
        Intent intent_cam = new Intent(Camera_ZH.this, Home.class);
        ...
        Toast.makeText(Camera_ZH.this, "Framing has been stopped/paused", Toast.LENGTH_SHORT).show();
        onPause();
            }
        });
        //Resume ---------------------------*/
        ...
        resume.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        Toast.makeText(Camera_ZH.this, "Camera framing resumed", Toast.LENGTH_SHORT).show();
        onResume();
            }
        });
        //TTS ----------------------------*/
        ...
        resolution.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(show_reso_list==0){ //when button is clicked
                    ...
                    Toast.makeText(Camera_ZH.this, "576 x 1280 is the recommended size for portrait capture", Toast.LENGTH_SHORT).show();
    ...
    switch (selectedLang) {
        case "Arabic (اللغة العربية)":
             try {
    Intent intent_cam = new Intent(Camera_ZH.this, Camera_AR.class);
    startActivity(intent_cam);
    ...
    listView.setVisibility(View.INVISIBLE);
       ...
       case "Chinese (普通话)":
            try {
    Intent intent_cam = new Intent(Camera_ZH.this, Camera_ZH.class);
    startActivity(intent_cam);
    Toast.makeText(getApplicationContext(), "COLOR LANGUAGE CHANGED", Toast.LENGTH_LONG).show();
    listView.setVisibility(View.INVISIBLE);
           } catch (Exception e) {
      ...
      case "English":
             try {
    Intent intent_cam = new Intent(Camera_ZH.this, Camera2.class);
    startActivity(intent_cam);
    Toast.makeText(getApplicationContext(), "COLOR LANGUAGE CHANGED", Toast.LENGTH_LONG).show();
    listView.setVisibility(View.INVISIBLE);
             } catch (Exception e) {
      ...
      case "Hindi (हिंदुई)":
             try {
    Intent intent_cam = new Intent(Camera_ZH.this, Camera_HI.class);
    startActivity(intent_cam);
    Toast.makeText(getApplicationContext(), "COLOR LANGUAGE CHANGED", Toast.LENGTH_LONG).show();
    listView.setVisibility(View.INVISIBLE);
            } catch (Exception e) {
      ...
      case "Portuguese (português)":
            try {
    Intent intent_cam = new Intent(Camera_ZH.this, Camera_PT.class);
    startActivity(intent_cam);
    Toast.makeText(getApplicationContext(), "COLOR LANGUAGE CHANGED", Toast.LENGTH_LONG).show();
    listView.setVisibility(View.INVISIBLE);
            } catch (Exception e) {
      ...
      case "Tagalog":
            try {
    Intent intent_cam = new Intent(Camera_ZH.this, Camera_TL.class);
    startActivity(intent_cam);
    Toast.makeText(getApplicationContext(), "COLOR LANGUAGE CHANGED", Toast.LENGTH_LONG).show();
    listView.setVisibility(View.INVISIBLE);
           } catch (Exception e) {
    ...
    Imgproc.goodFeaturesToTrack(mGray, corners, 10, 0.5, 20, new Mat(), 2, false);
       ...
       // }
        ...
        try {
    modelAndHeaderEN[0] = SerializationHelper.readAll(getAssets().open("l2_rgb_zh_k-1.model"));
        } catch (Exception e) {
            e.printStackTrace();
        }
   ...
   return mRgba;
    ...
    private void captureCam(ImageButton buttonCapture){
        ...
        Toast.makeText(Camera_ZH.this, "Took a picture", Toast.LENGTH_SHORT).show();
